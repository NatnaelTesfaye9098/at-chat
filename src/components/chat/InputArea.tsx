        ...
        <>
            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 w-[90%] max-w-5xl">
                <div className="relative">
                    ...
                    <button className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full bg-gray-300 dark:bg-gray-800 hover:bg-gray-400 hover:dark:bg-gray-900 p-3 cursor-pointer">
                        <FaArrowUp />
                    </button>
                </div>
            </div>
